	...
	<section class="text-gray-700 body-font overflow-hidden bg-white">
		<div class="container px-5 py-24 mx-auto" v-if="data">
			<div class="lg:w-4/5 mx-auto flex flex-wrap">
				<img :alt="data?.title" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200"
					:src="data?.image" />
						...
						<span class="flex items-center">
							...
							<div v-for="i in 5" :key="i">
								<svg fill="currentColor" stroke="currentColor" stroke-linecap="round"
									stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-red-500" :class="{
							...
							<span class="text-gray-600 ml-3">{{ data?.rating.count }} Reviews</span>
						</span>
